...
- **DynamoDB:** Server-side encryption is enabled by default on all tables in [main.tf](file:///home/dm/code/kernelworx/tofu/application/modules/dynamodb/main.tf#L60) using AWS-owned keys (no per-request KMS charges).
