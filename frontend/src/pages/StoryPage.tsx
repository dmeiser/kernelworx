            ...
            <CardContent>
              <Stack spacing={3}>
                ...
                <Typography variant="body1" color="text.primary">
                  ...
                  — paper orders, payments turned in by families, and making sure the Pack's final numbers added up
                  across all the individual forms. It was a lot to ask of a volunteer — and it made selling popcorn
                  harder for both parents and Scouts.
                </Typography>
                ...
                <Typography variant="body1" color="text.primary">
                  ...
                  please consider sponsoring through GitHub Sponsors. Any sponsorship helps defray the cost of hosting
                  and development. KernelWorx is not a non-profit, so donations are not tax deductible.
                </Typography>
              </Stack>
            </CardContent>
          </Card>
