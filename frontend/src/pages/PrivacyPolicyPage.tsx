        ...
        <Card>
          <CardContent sx={{ p: { xs: 2, sm: 4 } }}>
            ...
            <Typography variant="body1" paragraph>
              ...
              sell, rent, or share your personal information with third parties except as required to operate the
              service (e.g., AWS hosting).
            </Typography>
            ...
            <Box sx={{ bgcolor: 'error.50', p: 3, borderRadius: 1, border: '1px solid', borderColor: 'error.200' }}>
              ...
              <Typography variant="body1" paragraph sx={{ mt: 2, fontWeight: 600, color: 'error.main' }}>
                ⚠️ Important: You must send the email from the email address registered to your account. We verify
                account deletion requests by email address only.
              </Typography>
            ...
            <Box
              sx={{ bgcolor: 'info.50', p: 2, borderRadius: 1, border: '1px solid', borderColor: 'info.200', mt: 4 }}
            >
