...
locals {
  ...
  routes = [
    ...
    { path = "/scouts",                                    method = "GET",    lambda = "scouts",                 auth = false },
    { path = "/home",                                      method = "GET",    lambda = "scouts",                 auth = false },
    { path = "/catalogs",                                  method = "GET",    lambda = "catalogs",               auth = false },
    { path = "/payment-methods",                           method = "GET",    lambda = "payment-methods",        auth = false },
    { path = "/admin",                                     method = "GET",    lambda = "admin",                  auth = false },
    { path = "/campaigns",                                 method = "GET",    lambda = "campaigns",              auth = false },
    { path = "/orders",                                    method = "GET",    lambda = "orders",                 auth = false },
    { path = "/scout-management",                          method = "GET",    lambda = "sharing",                auth = false },
    { path = "/account/settings",                          method = "GET",    lambda = "sharing",                auth = false },
    ...
    { path = "/admin/user-data/{accountId}",               method = "GET",    lambda = "admin",                  auth = false },
    ...
    { path = "/scouts/{profileId}",                        method = "GET",    lambda = "campaigns",              auth = false },
    { path = "/scouts/{profileId}/campaigns",              method = "GET",    lambda = "campaigns",              auth = false },
    { path = "/scouts/{profileId}/campaigns/{campaignId}", method = "GET",    lambda = "orders",                 auth = false },
    { path = "/scouts/{profileId}/campaigns/{campaignId}/orders", method = "GET", lambda = "orders",            auth = false },
    { path = "/scouts/{profileId}/campaigns/{campaignId}/orders/{orderId}/edit", method = "GET", lambda = "orders", auth = false },
    { path = "/scouts/{profileId}/campaigns/{campaignId}/new",   method = "GET", lambda = "orders",              auth = false },
    { path = "/scouts/{profileId}/campaigns/{campaignId}/edit",  method = "GET", lambda = "orders",              auth = false },
    { path = "/scouts/{profileId}/manage",                 method = "GET",    lambda = "sharing",                auth = false },
  ]
