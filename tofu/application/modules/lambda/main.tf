...
# Import existing Lambda-managed CloudWatch log groups so retention can be managed.
# After the first apply in an environment where these groups already exist, these blocks can be removed.

import {
  to = aws_cloudwatch_log_group.functions["list-my-shares"]
  id = "/aws/lambda/${var.name_prefix}-list-my-shares-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["list-catalogs-in-use"]
  id = "/aws/lambda/${var.name_prefix}-list-catalogs-in-use-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["create-profile"]
  id = "/aws/lambda/${var.name_prefix}-create-profile-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["request-report"]
  id = "/aws/lambda/${var.name_prefix}-request-report-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["unit-reporting"]
  id = "/aws/lambda/${var.name_prefix}-unit-reporting-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["list-unit-catalogs"]
  id = "/aws/lambda/${var.name_prefix}-list-unit-catalogs-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["list-unit-campaign-catalogs"]
  id = "/aws/lambda/${var.name_prefix}-list-unit-campaign-catalogs-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["campaign-operations"]
  id = "/aws/lambda/${var.name_prefix}-campaign-operations-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["delete-profile-cascade"]
  id = "/aws/lambda/${var.name_prefix}-delete-profile-cascade-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["update-account"]
  id = "/aws/lambda/${var.name_prefix}-update-account-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["delete-account"]
  id = "/aws/lambda/${var.name_prefix}-delete-account-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["transfer-ownership"]
  id = "/aws/lambda/${var.name_prefix}-transfer-ownership-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["request-qr-upload"]
  id = "/aws/lambda/${var.name_prefix}-request-qr-upload-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["confirm-qr-upload"]
  id = "/aws/lambda/${var.name_prefix}-confirm-qr-upload-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["generate-qr-code-presigned-url"]
  id = "/aws/lambda/${var.name_prefix}-generate-qr-code-presigned-url-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["delete-qr-code"]
  id = "/aws/lambda/${var.name_prefix}-delete-qr-code-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["validate-payment-method"]
  id = "/aws/lambda/${var.name_prefix}-validate-payment-method-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.functions["admin-operations"]
  id = "/aws/lambda/${var.name_prefix}-admin-operations-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.trigger_functions["post-auth"]
  id = "/aws/lambda/${var.name_prefix}-post-auth-${var.region_abbrev}-${var.environment}"
}

import {
  to = aws_cloudwatch_log_group.trigger_functions["pre-signup"]
  id = "/aws/lambda/${var.name_prefix}-pre-signup-${var.region_abbrev}-${var.environment}"
}
