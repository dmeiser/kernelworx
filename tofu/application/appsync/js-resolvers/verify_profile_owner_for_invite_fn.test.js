...
import { request, response } from './verify_profile_owner_for_invite_fn.js';

describe('verify_profile_owner_for_invite_fn request', () => {
...
describe('verify_profile_owner_for_invite_fn response', () => {
    ...
    it('throws Unauthorized when profile is not found', () => {
        ...
        assert.throws(
            () => response(ctx),
            /Unauthorized: Forbidden: Only profile owner can create invites/
        );
    });
